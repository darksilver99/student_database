...
import 'classroom_from_page_model.dart';
...
class ClassroomFromPageWidget extends StatefulWidget {
  ...
  _ClassroomFromPageWidgetState createState() =>
      _ClassroomFromPageWidgetState();
}

class _ClassroomFromPageWidgetState extends State<ClassroomFromPageWidget> {
  late ClassroomFromPageModel _model;
  ...
  void initState() {
    ...
    _model.termController ??= TextEditingController();
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: 'ปีการศึกษา (เช่น 2565)',
                                  ...
                                  validator: _model.yearsControllerValidator
                                      .asValidator(context),
                                  inputFormatters: [
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  style:
                                      FlutterFlowTheme.of(context).bodyMedium,
                                  keyboardType: TextInputType.number,
                                  validator: _model.termControllerValidator
                                      .asValidator(context),
                                  inputFormatters: [
                                    FilteringTextInputFormatter.allow(
                                        RegExp('[a-zA-Z0-9]'))
